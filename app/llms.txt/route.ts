...
- Validators sharing a verified registrable domain cannot jointly satisfy quorum. Private-PSL shared-host tenants remain readable but contribute zero controller-independence votes. Shared unverified declarations remain a conservative overlap fallback. Inspect independence_basis and shared_validator_infrastructure_conflicts; origin control does not prove distinct operators.
